...
require_file "scripts/qemu-network-rx.sh"
...
require_file "scripts/qemu-block-cache.sh"
require_file "scripts/qemu-partition-parser.sh"
require_file "scripts/qemu-ahci-discovery.sh"
require_file "scripts/qemu-ahci-write-persistence.sh"
require_file "scripts/qemu-ahci-vantfs-persistence.sh"
require_file "scripts/qemu-ahci-persist-lifecycle.sh"
require_file "scripts/qemu-storage-auto-policy.sh"
require_file "scripts/qemu-nvme-discovery.sh"
require_file "scripts/qemu-nvme-write-persistence.sh"
