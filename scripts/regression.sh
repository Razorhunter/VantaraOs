...
bash "${ROOT_DIR}/scripts/qemu-network-rx.sh"
...
bash "${ROOT_DIR}/scripts/qemu-ahci-discovery.sh"
bash "${ROOT_DIR}/scripts/qemu-ahci-write-persistence.sh"
bash "${ROOT_DIR}/scripts/qemu-ahci-vantfs-persistence.sh"
bash "${ROOT_DIR}/scripts/qemu-ahci-persist-lifecycle.sh"
bash "${ROOT_DIR}/scripts/qemu-storage-auto-policy.sh"
bash "${ROOT_DIR}/scripts/qemu-nvme-discovery.sh"
bash "${ROOT_DIR}/scripts/qemu-nvme-write-persistence.sh"
