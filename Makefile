...
.PHONY: help build shell docker-preemption-test docker-regression fmt check test run smoke boot-test command-smoke command-smoke-ls command-smoke-cat command-smoke-procs command-smoke-rusthello command-smoke-threaddemo preemption-test isolation-test artifact-manifest abi-check unsafe-audit regression ci kernel-fmt kernel-check kernel-test kernel-build kernel-run kernel-vnc kernel-headless userland-fmt userland-check userland-bin kernel-clean clean
...
command-smoke-ls command-smoke-cat command-smoke-procs command-smoke-rusthello command-smoke-threaddemo: kernel-build
